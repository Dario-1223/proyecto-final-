...
class ProduccionController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            if (Auth()->user()->rol === 'administrador') {
                return redirect()->route('Administrador.produccion.index')->with('success', 'Produccion creada exitosamente.');
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if (Auth()->user()->rol === 'administrador') {
                return redirect()->route('Administrador.produccion.index')->with('success', 'Produccion actualizada exitosamente.');
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            if (Auth()->user()->rol === 'administrador') {
                return redirect()->route('Administrador.produccion.index')->with('success', 'Produccion eliminada exitosamente.');
